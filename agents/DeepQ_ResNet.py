...
class DQN_ResNet(object):
    ...
    def __init__(self, conf, action_size, state_size, device):
        ...
        self.policy_net = models.resnet50(pretrained=False)
        num_ftrs = self.policy_net.fc.in_features
        self.policy_net.fc = nn.Linear(num_ftrs, self.action_size)  # Modify the final layer to match action_size
